...
console.log(dna.trim(dna = " TCG-TAC-gaC-TAC-CGT-CAG-ACT-TAa-CcA-GTC-cAt-AGA-GCT "));
...
let dnaThree = ("TCG-TAC-GAC-TAC-CGT-CAG-ACT-TAA-CCA-GTC-AGA-GCT");
if (dnaThree.indexOf("CAT")>-1){
